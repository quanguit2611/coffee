...
/*lấy icon bookmark và 2 ảnh background của section */
...
const Reservation = () => {
    return (
        <section className="reservation container" id="reservation">
            ...
            {/* form đặt chỗ trước (tất nhiên là chưa có xử lý data rồi :v) */}
            <form className="reservation__form grid">
                ...
                <div className="form__input-div">
                    <input type="text" placeholder='Time Ex: 1:25PM' className="form__input" />
                </div>
